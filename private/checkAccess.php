...
// <rsp stat='ok' />
//
function qruqsp_dashboard_checkAccess(&$ciniki, $tnid, $method) {
    //
    ...
    if( !isset($rc['ruleset']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'qruqsp.dashboard.1', 'msg'=>'No permissions granted'));
    }
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'qruqsp.dashboard.2', 'msg'=>'Access denied.'));
    }
    //
    ...
    // By default fail
    //
    return array('stat'=>'fail', 'err'=>array('code'=>'qruqsp.dashboard.3', 'msg'=>'Access denied'));
}
?>
