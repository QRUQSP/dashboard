...
class MoonPhase
{
    ...
    */
    public function __construct($date = null)
    {
        ...
        $this->MoonAge = $lPP - $Lambdasun;                                    // Age of the Moon in degrees
        $MoonPhase = (1 - cos(deg2rad($this->MoonAge))) / 2;                    // Phase of the Moon
        ...
        // Store results
        $this->phase = $this->fixangle($this->MoonAge) / 360;                    // Phase (0 to 1)
    ...
    */
    ...
    public function phase_deg(): float
    {
        return $this->fixangle($this->MoonAge);
    }
