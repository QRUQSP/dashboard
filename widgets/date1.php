...
function qruqsp_dashboard_widgets_date1(&$ciniki, $tnid, $args) {
    ...
    $widget['content'] .= "<text x='100' y='48' width='180' height='74' font-size='{$date_font_size}' fill='#ccc'>"
        . "<tspan id='widget-{$widget['id']}-date' dominant-baseline='middle' alignment-baseline='middle' text-anchor='middle'>"
        . $widget['data']['date']
        . "</tspan></text>";
    $widget['content'] .= "<text x='100' y='114' width='180' height='74' font-size='{$time_font_size}' fill='#fff'>"
